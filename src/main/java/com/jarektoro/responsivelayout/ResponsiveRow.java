...
public class ResponsiveRow extends StyleableLayout {
    ...
    public ResponsiveRow withColumn(Component component) {
        addColumn(component);
        return this;
    }

    public ResponsiveColumn addColumn(Component component) {
        ResponsiveColumn column = new ResponsiveColumn();
        if (column != null) {
            column.withComponent(component);
        }
    ...
    public ResponsiveColumn addColumn() {
        return addColumn((Component) null);
    }
